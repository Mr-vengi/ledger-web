 ...
 * 
 * This cloud function is a Node.js reference implementation using pdfmake library.
...
exports.generateLedgerPDF = functions.https.onCall(async (data, context) => {
  try {
    ...
    // Calculate column widths to match Flutter's FlexColumnWidth ratios
    // Flutter: [1.8, 2.5, 1.5, 1.5, 1.5] = total 8.8
    // Convert to percentages for A4 page width (595 points - 40 margin = 555 points)
    const totalRatio = 1.8 + 2.5 + 1.5 + 1.5 + 1.5; // 8.8
    const availableWidth = 555; // A4 width minus margins
    const columnWidths = [
      (1.8 / totalRatio) * availableWidth, // Date: ~113.5
      (2.5 / totalRatio) * availableWidth, // Particulars: ~157.7
      (1.5 / totalRatio) * availableWidth, // Type: ~94.6
      (1.5 / totalRatio) * availableWidth, // Credit: ~94.6
      (1.5 / totalRatio) * availableWidth, // Debit: ~94.6
    ];
    ...
    const docDefinition = {
      ...
      defaultStyle: {
        font: 'Helvetica', // Set default font to Helvetica
      },
      content: [
        // Header
        shopNameHeader,
        ...
        // Table
        {
          table: {
            headerRows: 1,
            widths: columnWidths, // Match Flutter's column widths
            body: [
              // Header row
              [
                {
          ...
          layout: {
            ...
            vLineWidth: function () {
              return 0; // No vertical lines (matches Flutter)
            },
            ...
            fillColor: function (rowIndex, node, columnIndex) {
              ...
              if (rowIndex === 0) return '#E5E5E5'; // Header (grey200)
              ...
              if (
                ...
                return '#F5F5F5'; // Grey background for special rows (grey100)
              }
              return null;
            },
          },
